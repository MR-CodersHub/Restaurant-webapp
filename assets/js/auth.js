...
class AuthSystem {
  ...
  updateUI() {
    ...
    // Standardize user dropdown items
    if (userDropdown) {
      userDropdown.innerHTML = `
        <button type="button" data-action="login-signup">Login/Signup</button>
        <button type="button" data-action="admin-dashboard">Admin Dashboard</button>
        <button type="button" data-action="user-dashboard">User Dashboard</button>
      `;
    }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.addEventListener("click", (e) => {
    if (e.target.closest('[data-action="login-signup"]')) {
      e.preventDefault();
  ...
  document.addEventListener("click", (e) => {
    if (e.target.closest('[data-action="admin-dashboard"]')) {
      e.preventDefault();
      window.location.href = "admin-dashboard.html";
    }
  });

  // Handle user-dashboard button click
  document.addEventListener("click", (e) => {
    if (e.target.closest('[data-action="user-dashboard"]')) {
      e.preventDefault();
      window.location.href = "user-dashboard.html";
    }
  });
